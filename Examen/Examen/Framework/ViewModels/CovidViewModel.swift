...
class CovidViewModel: ObservableObject {
    ...
    func loadCovidData() {
        let countries = ["Mexico", "United States", "Canada", "India", "Brazil", "Germany", "Croatia", "Argentina", "Russia", "France", "Spain", "China", "Japan", "Nicaragua", "Italy", "Colombia"]  // Aquí puedes agregar más países
